...
categories:
  - mysql
description: mysql数据库定时备份&运行日志定时清理
abbrlink: 25283
date: 2023-04-06 16:25:00
---
备份脚本
```
#!/bin/bash
...
定时任务脚本
```
0 4 * * * /mysqldata/mysqlbackup_ticket/mysqlBackup.sh > /mysqldata/mysqlbackup_ticket/log.txt 2>&1 
```
定时任务相关命令
```
# 启动cron服务[命令没有提示]
